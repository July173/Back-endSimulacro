...
namespace Entity.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RolFormPermissions_Forms_FormId1",
                        column: x => x.FormId1,
                        principalTable: "Forms",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RolFormPermissions_Permissions_PermissionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Neighborhoods_NeighborhoodId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolFormPermissions_FormId1",
                table: "RolFormPermissions",
                column: "FormId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolFormPermissions_PermissionId1",
                table: "RolFormPermissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_NeighborhoodId1",
                table: "Users",
                column: "NeighborhoodId1",
                unique: true,
                filter: "[NeighborhoodId1] IS NOT NULL");
